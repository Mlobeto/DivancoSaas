...
export class AzureBlobStorageAdapter implements FileStorageProvider {
  ...
  async uploadFile(params: UploadFileParams): Promise<UploadFileResult> {
    try {
      ...
      console.error("[AzureBlobStorageAdapter] Upload error:", error);
  ...
  async downloadFile(params: DownloadFileParams): Promise<DownloadFileResult> {
    try {
      ...
      console.error("[AzureBlobStorageAdapter] Download error:", error);
  ...
  async deleteFile(params: DeleteFileParams): Promise<void> {
    try {
      ...
      console.error("[AzureBlobStorageAdapter] Delete error:", error);
  ...
  async generateSasToken(params: GenerateSasTokenParams): Promise<string> {
    try {
      ...
      console.error("[AzureBlobStorageAdapter] SAS token error:", error);
  ...
  async processImage(
    ...
    try {
      ...
      console.error("[AzureBlobStorageAdapter] Image processing error:", error);
  ...
  async listFiles(params: ListFilesParams): Promise<FileMetadata[]> {
    try {
      ...
      console.error("[AzureBlobStorageAdapter] List files error:", error);
  ...
  async getFileMetadata(
    ...
    try {
      ...
      console.error("[AzureBlobStorageAdapter] Get metadata error:", error);
