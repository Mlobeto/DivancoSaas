...
export class MercadoPagoAdapter
  implements PlatformPaymentProvider, WebhookAdapter
{
  ...
  async parseWebhook(
    ...
    try {
      ...
      const event: PaymentEvent = {
        ...
        eventType: this.mapMercadoPagoEventType(
          rawPayload.action,
  ...
  private mapMercadoPagoEventType(
    action: string,
    status: string,
  ): PaymentEventType {
    ...
    if (action === "payment.updated" && status === "refunded")
      return PaymentEventType.REFUND_COMPLETED;
