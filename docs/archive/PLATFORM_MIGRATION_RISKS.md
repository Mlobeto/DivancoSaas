...
> Este análisis aplica a una fase de refactor anterior y no debe usarse como estado actual del proyecto.  
> Referencia vigente: [README.md](./README.md) + [ARQUITECTURA.md](./ARQUITECTURA.md).
