...
> Esta guía fue útil durante el cambio de arquitectura; algunos pasos pueden estar cerrados o superados.  
> Para cambios actuales usar: [README.md](./README.md), [FRONTEND_ARCHITECTURE.md](./FRONTEND_ARCHITECTURE.md) y [GUARD_RAILS.md](./GUARD_RAILS.md).
