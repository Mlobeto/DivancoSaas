...
> Este documento describe una transición por fases; no debe usarse como guía principal para cambios nuevos.  
> Fuente vigente: [README.md](./README.md) + [FRONTEND_ARCHITECTURE.md](./FRONTEND_ARCHITECTURE.md) + [ARQUITECTURA.md](./ARQUITECTURA.md).
